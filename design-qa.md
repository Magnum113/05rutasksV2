...
- MVP: `http://127.0.0.1:5174/?screen=wheel-mvp`
- Полная версия: `http://127.0.0.1:5174/?screen=wheel-full`
...
- Повторное открытие уже полученного промокодного приза из вкладки «Вы выиграли» и повторное копирование сохранённого кода.
- Получение бонусов.
- Сохранение незабранного приза без блокировки следующего вращения.
